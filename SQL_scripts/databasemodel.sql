...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `ZooManagementDB` ;

-- -----------------------------------------------------
-- Schema ZooManagementDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ZooManagementDB` DEFAULT CHARACTER SET utf8mb4 ;
USE `ZooManagementDB` ;
...
CREATE TABLE IF NOT EXISTS `ZooManagementDB`.`Employee` (
  ...
  INDEX `Employee_Manager.FK_idx` (`manager` ASC) VISIBLE,
  INDEX `Employee_User.FK_idx` (`user` ASC) VISIBLE,
  CONSTRAINT `Employee_Manager.FK`
    FOREIGN KEY (`manager`)
...
CREATE TABLE IF NOT EXISTS `ZooManagementDB`.`Accountant` (
  ...
  `employee` TINYINT NOT NULL,
  PRIMARY KEY (`accountant_id`, `employee`),
...
CREATE TABLE IF NOT EXISTS `ZooManagementDB`.`Ships` (
  ...
  `item` INT NOT NULL,
  PRIMARY KEY (`ships_id`, `item`, `vendor`, `shipment`),
