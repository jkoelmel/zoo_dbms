...
class DB:
    ...
    transactions = open("transactions.sql")
    ...
    def create_database(self, database=None, drop_database_first=True):
        ...
        try:
          ...
          connection.cursor().execute(query)
          connection.commit() # permanent save to the database
    ...
    def wildcards(self, num_wildcards):
        list_wildcards = []
